...
Not: In case of multiple admins are assigned, they may all send
   message on your behalf, but only the 0th admin can receive direct
...
Not: You may introduce non-ETM admin users to the group, however,
   they:
...
Not: Type can be either “User” or “Group”Other is the vendor specific
...
Not: This only applies to Telegram groups that are linked to a single
...
Uyarı: The ``xmlrpc`` module is not secure against maliciously
