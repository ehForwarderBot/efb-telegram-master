...
Catatan: In case of multiple admins are assigned, they may all send message
...
Catatan: You may introduce non-ETM admin users to the group, however, they:
...
Catatan: Type can be either “User” or “Group”Other is the vendor specific
