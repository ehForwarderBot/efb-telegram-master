...
備註: In case of multiple admins are assigned, they may all send message
...
備註: You may introduce non-ETM admin users to the group, however, they:
...
備註: Type can be either “User” or “Group”Other is the vendor specific
